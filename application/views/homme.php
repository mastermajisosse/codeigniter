...
<head>
    ...
    <style>
        ...
        .c{
            background-image: url("<?php echo base_url("resourses/img/1.jpg"); ?>");
            background-size: cover;
        }
        h1 {
            font-size: 45px;
            margin: 250px 270px;
            text-shadow: 2px -1px 5px rgba(255, 255, 255, 0.43), 0 1px 2px rgba(255, 255, 255, 0.96);
...
<h1>Bienvenu dans l'application de reunion</h1>
